...
input_layout = "/run/media/thuat/build/cmos/MulColRO/gds/user_analog_project_wrapper.gds"
output = "/run/media/thuat/build/cmos/MulColRO/precheck_results/23_SEP_2023___09_48_43/tmp/layout.txt"
...
for cell_it in layout_view.each_cell():
    if cell_it.name.endswith("user_analog_project_wrapper"):
